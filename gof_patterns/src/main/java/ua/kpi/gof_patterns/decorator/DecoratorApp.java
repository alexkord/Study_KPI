package ua.kpi.gof_patterns.decorator;

public class DecoratorApp {
    public static void main(String[] args) {
        PrinterInterface printer1 = new Printer("Привет");
        PrinterInterface printer2 = new QuotesDecorator(new RightBracketDecorator(new LeftBracketDecorator(new Printer("Привет"))));
        printer2.print();
    }
}
